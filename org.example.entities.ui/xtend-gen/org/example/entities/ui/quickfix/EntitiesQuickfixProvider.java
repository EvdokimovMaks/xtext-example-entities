...
public class EntitiesQuickfixProvider extends DefaultQuickfixProvider {
  ...
  public void capitalizeEntityNameFirstLetter(final Issue issue, final IssueResolutionAcceptor acceptor) {
    ...
    acceptor.accept(issue, "Capitalize first letter", _plus, 
  ...
  public void lowercaseAttributeNameFirstLetter(final Issue issue, final IssueResolutionAcceptor acceptor) {
    ...
    acceptor.accept(issue, "Uncapitalize first letter", _plus, 
  ...
  public void removeSuperType(final Issue issue, final IssueResolutionAcceptor acceptor) {
    ...
    acceptor.accept(issue, "Remove supertype", _builder.toString(), 
