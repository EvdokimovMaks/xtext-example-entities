...
class EntitiesQuickfixProvider extends DefaultQuickfixProvider {
	...
	def void capitalizeEntityNameFirstLetter(Issue issue, IssueResolutionAcceptor acceptor) {
		acceptor.accept(issue, "Capitalize first letter",
			"Capitalize first letter of " + issue.data.get(0),
			"Entity.gif",
			[
				context | 
				val xtextDocument = context.xtextDocument
				var firstLetter = xtextDocument.get(issue.offset, 1);
	...
	def void lowercaseAttributeNameFirstLetter(Issue issue, IssueResolutionAcceptor acceptor) {
		acceptor.accept(issue, "Uncapitalize first letter", 
	...
	def void removeSuperType(Issue issue, IssueResolutionAcceptor acceptor) {
		acceptor.accept(issue, "Remove supertype", 
